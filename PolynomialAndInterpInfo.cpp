...
double NewtonIPoly::deltaY(int i) {
...
// »нтерпол€ци€ по полиному Ќьютона II работает на данный момент неисправно.
// Ѕыло вы€влено, что ошибка кроетс€ веро€тнее всего в ф-ции deltaY. ќтладить ф-цию
// и провести необходимые тесты.
double NewtonIIPoly::deltaY(int i) {
